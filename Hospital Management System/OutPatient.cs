...
namespace Hospital_Management_System
{
    public partial class OutPatient : Form
    {
        ...
        private void showTable()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM outpatient", con);
        ...
        private void save()
        {
            string insertCommand = "INSERT INTO outpatient(PatientID,FirstName,LastName,Gender,Occupation,DateOfBirth,Age,BloodGroup,MaritalStatus,Address,City,Country,PIN,ContactNo,Depertment,ConsultantName,date) " +
                                                 "VALUES(@PatientID,@FirstName,@LastName,@Gender,@Occupation,@DateOfBirth,@Age,@BloodGroup,@MaritalStatus,@Address,@City,@Country,@PIN,@ContactNo,@Depertment,@ConsultantName,@date)";
        ...
        private void search()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM outpatient WHERE PatientID LIKE ('" + textBox1.Text + "%')", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void delete()
        {
            string deleteCommand = "DELETE FROM outpatient WHERE PatientID=@PatientID";
